################ FSW in Manzini and Mbabane with binomial prior for N  ####################
...
########## Initial parameter specification ###############using Jeffrey's prior ###############
...
# TRS (MANZINI) #
M_2_size=20323 # Total female population in Manzini 
x_111_2=34
x_101_2=51
x_011_2=44
x_001_2=128
...
# TRS (MBABANE) #
M_3_size=16796 # Total female population in Mbabane
x_111_3=12
x_101_3=81
x_011_3=7
x_001_3=155
...
x_.1._0=186  # SUM OF THE MARGINAL COUNTS OF LIST 2 OF MANZINI & MBABANE FOR FSW

K=x_.1._0-x_.11_2-x_.11_3

G_star=70    # lower limit of the List 2 marginal count in Mbabane
...
phi_2[1]=rbeta(1,N_2+a_phi,M_2_size+b_phi-N_2) 
...
for(h in 2:tot){
  ...
  z_010_2[1]=round(K1/2)
  z_010_3[1]=K1-z_010_2[1]
  
  
  K2=K-z_010_2[1]-z_010_3[1]
  ...
  upper_z_010_2=min(size_param_z_010_2,K1,K1+K2-G-z_110_2[h-1])
  ...
  upper_z_110_2=min(size_param_z_110_2,K2,K1+K2-G-z_010_2[h])
  ...
  # Generating phi_2 #
  phi_2[h]=rbeta(1,N_2_estimate[h-1]+a_phi,M_2_size+b_phi-N_2_estimate[h-1])  
  
  # Generating population size #
  
  p_000_2[h]=(1-beta_0_2[h])*(1-p_2[1,h])*(1-p_2[2,h])*(1-p_2[3,h])
  
  w_2=rbinom(1,M_2_size-NN_2,((phi_2[h]*p_000_2[h])/(1-phi_2[h]+(phi_2[h]*p_000_2[h]))))
  ...
  # Generating phi_3 #
  phi_3[h]=rbeta(1,N_3_estimate[h-1]+a_phi,M_3_size+b_phi-N_3_estimate[h-1])  
  
  # Generating population size #
  
  p_000_3[h]=(1-beta_0_3[h])*(1-p_3[1,h])*(1-p_3[2,h])*(1-p_3[3,h])
  
  w_3=rbinom(1,M_3_size-NN_3,((phi_3[h]*p_000_3[h])/(1-phi_3[h]+(phi_3[h]*p_000_3[h]))))
